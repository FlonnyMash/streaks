      ...
      <TodoTimerProvider>
        <TodoTimePromptProvider>
          <div className="min-h-dvh flex flex-col app-shell">
            ...
            <GlassNavbar />
            <MobileTopBar />
            <main className="flex-1 mx-auto w-full max-w-5xl px-4 sm:px-6 pt-2 sm:pt-[calc(6.5rem+env(safe-area-inset-top,0px))] pb-[calc(5.5rem+var(--safe-area-bottom,env(safe-area-inset-bottom,0px)))] sm:pb-8">
              <Outlet />

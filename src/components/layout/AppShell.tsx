...
export function AppShell() {
  return (
    <div className="min-h-dvh flex flex-col app-shell">
      <PasskeySetupPrompt />
      <GlassNavbar />
      <main className="flex-1 mx-auto w-full max-w-5xl px-4 sm:px-6 pt-[calc(1.25rem+env(safe-area-inset-top,0px))] sm:pt-[calc(5rem+env(safe-area-inset-top,0px))] pb-[calc(5.5rem+var(--safe-area-bottom,env(safe-area-inset-bottom,0px)))] sm:pb-8">
        <Outlet />

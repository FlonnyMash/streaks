  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 app-desktop:grid-cols-2 gap-4 items-start">
        ...
        <section className="app-desktop:col-span-2">
          <h2 className="text-[13px] font-semibold text-black/45 dark:text-white/45 uppercase tracking-wide mb-2 px-1">
            Danger zone
          </h2>
          <div className="glass-panel rounded-[24px] p-5 border border-accent-red/20">
            <div className="flex flex-col app-desktop:flex-row app-desktop:items-center gap-4">
              ...
              {!confirmDelete ? (
                <Button variant="danger" size="sm" className="shrink-0 self-start app-desktop:self-center" onClick={() => setConfirmDelete(true)}>
                  <Trash2 className="size-4" />
                  Delete my account
                </Button>
              ) : (
                <div className="flex flex-col gap-2 shrink-0 self-start app-desktop:self-center">
